...
*/
(function(d){ true&&module.exports?(d["default"]=d,module.exports=d): true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! highcharts */ "./node_modules/highcharts/highcharts.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(w){d(w);d.Highcharts=w;return d}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):undefined})(function(d){function w(a,n,d,g){a.hasOwnProperty(n)||(a[n]=g.apply(null,d))}d=d?d._modules:{};w(d,"parts-map/MapAxis.js",[d["parts/Globals.js"],d["parts/Utilities.js"]],function(a,n){var d=n.addEvent,g=n.pick;a=a.Axis;d(a,"getSeriesExtremes",
...
/* harmony import */ var highcharts_modules_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! highcharts/modules/map */ "./node_modules/highcharts/modules/map.js");
...
function LeafletLayersDemoComponent_ng_container_0_ng_container_2_highcharts_chart_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "highcharts-chart", 4);
} if (rf & 2) {
    const u_r31 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function LeafletLayersDemoComponent_ng_container_0_ng_container_2_Template(rf, ctx) { if (rf & 1) {
...
function LeafletLayersDemoComponent_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
class LeafletLayersDemoComponent {
    constructor(http) {
        ...
        this.data = this.http.get(`http://${window.location.hostname}:8080/heat?responseDate=${new Date(new Date().getTime() - (3600 * 24 * 1000)).toISOString().substring(0, 10)}`).toPromise();
        this.chartMap = Promise.all([this.world, this.data]).then(([mapWorld, data]) => {
...
LeafletLayersDemoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LeafletLayersDemoComponent, selectors: [["leafletLayersDemo"]], inputs: { questionId: "questionId" }, decls: 2, vars: 3, consts: [[4, "ngIf"], [3, "ngSwitch"], [4, "ngFor", "ngForOf"], ["style", "width: 100%; height:100%; display: block;", 3, "Highcharts", "constructorType", "options", 4, "ngSwitchCase"], [2, "width", "100%", "height", "100%", "display", "block", 3, "Highcharts", "constructorType", "options"]], template: function LeafletLayersDemoComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LeafletLayersDemoComponent, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }]; }, { questionId: [{
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _layers_layers_demo_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./layers/layers-demo.component */ "./src/app/schland/layers/layers-demo.component.ts");
...
function SchlandPage_ng_container_13_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const q_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
SchlandPage.ɵfac = function SchlandPage_Factory(t) { return new (t || SchlandPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_question_service__WEBPACK_IMPORTED_MODULE_2__["QuestionService"])); };
SchlandPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SchlandPage, selectors: [["app-schland"]], decls: 14, vars: 4, consts: [["slot", "start"], [3, "questionId"], [3, "value", "ionChange"], [3, "value", 4, "ngFor", "ngForOf"], [4, "ngFor", "ngForOf"], [3, "value"], ["style", "text-align: center; background: #BCFFF7; padding: 0.2rem; color: #002C27", 4, "ngIf"], [2, "text-align", "center", "background", "#BCFFF7", "padding", "0.2rem", "color", "#002C27"]], template: function SchlandPage_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SchlandPage, [{
    ...
    }], function () { return [{ type: _services_question_service__WEBPACK_IMPORTED_MODULE_2__["QuestionService"] }]; }, null); })();
