...
const { Clipboard } = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"];
let SettingsPage = class SettingsPage {
    constructor(userService, settingsService, notificationService, toastController) {
        ...
        this.settings$ = this.settingsService.settings$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(s => {
            return Object.assign({}, s, { reminderPushNotification: Object.assign({}, s.reminderPushNotification, { time: (() => {
                        const date = new Date();
    ...
    setReminderPushNotificationTime(time) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
