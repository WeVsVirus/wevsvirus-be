...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
  ...
  function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SignupPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 36,
      vars: 1,
      consts: [["fullscreen", "", "scroll-y", "false", 1, "ion-padding"], ["pager", "true"], ["slider", ""], [1, "slide"], ["src", "./assets/logo.jpg"], ["fill", "clear", 3, "click"], ["slot", "end", "name", "arrow-forward"], ["src", "./assets/slide-2.png"], ["src", "./assets/slide-3.png"], [1, "user-id"], ["routerLink", "user-sign-up-page", "fill", "clear"]],
