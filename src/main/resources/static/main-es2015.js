...
const routes = [{
        ...
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]],
        loadChildren: () => __webpack_require__.e(/*! import() | personal-report-personal-report-module */ "personal-report-personal-report-module").then(__webpack_require__.bind(null, /*! ./personal-report/personal-report.module */ "./src/app/personal-report/personal-report.module.ts")).then(m => m.PersonalReportPageModule),
    }];
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicRouteStrategy"] }], imports: [[
...
class UserService {
    ...
    signUp(data) {
        var _a;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.user = Object.assign(Object.assign({}, data), { id: (_a = this.user) === null || _a === void 0 ? void 0 : _a.id, pet: data.pet === '1' });
            yield this.http
...
module.exports = __webpack_require__(/*! /Users/nr/dev/wevsvirus-fe/src/main.ts */"./src/main.ts");
