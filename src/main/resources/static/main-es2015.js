...
/* harmony import */ var _guards_unauth_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./guards/unauth.guard */ "./src/app/guards/unauth.guard.ts");
...
const routes = [
    ...
    {
        path: 'imprint',
        loadChildren: () => __webpack_require__.e(/*! import() | imprint-imprint-module */ "imprint-imprint-module").then(__webpack_require__.bind(null, /*! ./imprint/imprint.module */ "./src/app/imprint/imprint.module.ts")).then(m => m.ImprintPageModule)
    },
    {
        path: 'settings',
...
/* harmony import */ var _services_question_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/question.service */ "./src/app/services/question.service.ts");
...
let AppModule = class AppModule {
    constructor(platform, settingsService, notificationService) {
        this.platform = platform;
        this.settingsService = settingsService;
        this.notificationService = notificationService;
        settingsService.settings$
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["skip"])(1), //
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(s => s.reminderPushNotification), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["distinctUntilChanged"])(lodash__WEBPACK_IMPORTED_MODULE_14__["isEqual"]))
            .subscribe(({ enabled, time }) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.notificationService.cancelAll();
            if (enabled) {
                try {
                    yield this.notificationService.schedule([{
                            title: 'Bleib am Ball',
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _services_question_service__WEBPACK_IMPORTED_MODULE_9__["QuestionService"],
...
/* harmony import */ var _chart_card_chart_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chart-card/chart-card.component */ "./src/app/base/chart-card/chart-card.component.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
...
/* harmony import */ var _slider_slider_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./slider/slider.component */ "./src/app/base/slider/slider.component.ts");
/* harmony import */ var _time_pipe_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./time-pipe.pipe */ "./src/app/base/time-pipe.pipe.ts");
/* harmony import */ var _privacy_privacy_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./privacy/privacy.component */ "./src/app/base/privacy/privacy.component.ts");
...
BaseModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _chart_card_chart_card_component__WEBPACK_IMPORTED_MODULE_3__["ChartCardComponent"],
            _slider_slider_component__WEBPACK_IMPORTED_MODULE_6__["SliderComponent"],
            _time_pipe_pipe__WEBPACK_IMPORTED_MODULE_7__["TimePipePipe"],
...
/* harmony import */ var observable_input__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! observable-input */ "./node_modules/observable-input/lib/index.js");
/* harmony import */ var observable_input__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(observable_input__WEBPACK_IMPORTED_MODULE_8__);
...
let ChartCardComponent = class ChartCardComponent {
    constructor(apiService, userService, questionService, toastController) {
        ...
        this.dates = Array
            ...
            .reverse();
        this.title$ = this.mode.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])((m) => `Deine ${m === 'mood' ? 'Stimmung' : 'Aktivität'}`));
        this.questions$ = this.mode.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])((mode) => this.questionService[`${mode}Questions`]));
        ...
        this.chart$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["combineLatest"])([
            this.mode,
            this.render$,
        ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(([mode]) => this.computeChart(mode)));
        this.computeChart = (mode) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return ({
                type: 'line',
                data: yield this.loadData(mode),
                colors: [],
                legend: false,
        ...
        this.loadData = (mode) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const data = yield this.apiService[mode === 'mood' ? 'getMood' : 'getHealth'](this.userService.user.id);
            return this.questionService[`${mode}Questions`].map((q) => {
                return ({
                    id: q.id,
    ...
    toggleQuestion(q) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const top = yield this.toastController.getTop();
            if (top) {
                top.dismiss();
            }
...
ChartCardComponent.ctorParameters = () => [
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    Object(observable_input__WEBPACK_IMPORTED_MODULE_8__["ObservableInput"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", rxjs__WEBPACK_IMPORTED_MODULE_6__["Observable"])
], ChartCardComponent.prototype, "mode", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(ng2_charts__WEBPACK_IMPORTED_MODULE_9__["BaseChartDirective"], null),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", ng2_charts__WEBPACK_IMPORTED_MODULE_9__["BaseChartDirective"])
], ChartCardComponent.prototype, "chart", void 0);
ChartCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'chart-card',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chart-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/base/chart-card/chart-card.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chart-card.component.scss */ "./src/app/base/chart-card/chart-card.component.scss")).default]
    }),
...
PrivacyComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'privacy',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./privacy.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/base/privacy/privacy.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./privacy.component.scss */ "./src/app/base/privacy/privacy.component.scss")).default]
    }),
...
], SliderComponent.prototype, "emoji", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
...
SliderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'slider',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./slider.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/base/slider/slider.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./slider.component.scss */ "./src/app/base/slider/slider.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
], SliderComponent);
...
let TimePipePipe = class TimePipePipe {
    transform(value) {
        const d = moment__WEBPACK_IMPORTED_MODULE_2__["duration"](value, 'hours');
        return [
            Object(lodash__WEBPACK_IMPORTED_MODULE_3__["padStart"])(String(d.hours()), 2, '0'),
            Object(lodash__WEBPACK_IMPORTED_MODULE_3__["padStart"])(String(d.minutes()), 2, '0'),
        ].join(':');
    }
};
...
let AuthGuard = class AuthGuard {
    ...
    canActivate(next, state) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (!(yield this.userService.loadUser())) {
...
/* harmony import */ var _privacy_privacy_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./privacy/privacy.modal */ "./src/app/modal/privacy/privacy.modal.ts");
...
ModalModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _privacy_privacy_modal__WEBPACK_IMPORTED_MODULE_6__["PrivacyModal"],
        ],
        entryComponents: [
            _privacy_privacy_modal__WEBPACK_IMPORTED_MODULE_6__["PrivacyModal"],
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrivacyModal", function() { return PrivacyModal; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
...
PrivacyModal = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-privacy',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./privacy.modal.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modal/privacy/privacy.modal.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./privacy.modal.scss */ "./src/app/modal/privacy/privacy.modal.scss")).default]
    }),
...
let ApiService = class ApiService {
    constructor(http) {
        ...
        this.register = (user) => this.http.post(`${this.baseUrl}/register`, user).toPromise();
        this.getMood = (userId) => this.http.get(`${this.baseUrl}/mood?id=${userId}`).toPromise();
        this.getHealth = (userId) => this.http.get(`${this.baseUrl}/health?id=${userId}`).toPromise();
        this.getHeat = (date) => this.http.get(`${this.baseUrl}/heat?responseDate=${date}`).toPromise();
        this.postQuestionnaire = (questionnaire) => this.http.post(`${this.baseUrl}/questionnaire`, questionnaire).toPromise();
    }
};
...
let NotificationService = class NotificationService {
    constructor(api, alertController, settingsService) {
        this.api = api;
        this.alertController = alertController;
        this.settingsService = settingsService;
        this.getPending = () => LocalNotifications.getPending();
    }
    ...
    enabled() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                return (yield LocalNotifications.areEnabled()).value;
            }
            catch (e) {
                return undefined;
            }
    ...
    schedule(notifications) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                yield LocalNotifications.schedule({ notifications });
            }
            catch (e) {
                (yield this.alertController.create({
                    header: 'Ups ...',
    ...
    requestPermission() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const { granted } = yield LocalNotifications.requestPermission();
            if (!granted) {
    ...
    cancelAll() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const { notifications } = yield this.getPending();
            if (notifications.length > 0) {
                yield LocalNotifications.cancel({ notifications });
            }
        });
    }
};
...
let QuestionService = class QuestionService {
    constructor(api, userService) {
        ...
        this.onSave$ = this.valueChanges$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(150), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.api.postQuestionnaire({
    ...
    setValue(id, value) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.storeValue(id, value);
        });
    }
    storeValue(id, value) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
let SettingsService = SettingsService_1 = class SettingsService {
    constructor() {
        ...
        this.settings$ = this.subject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(v => !!v), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(lodash__WEBPACK_IMPORTED_MODULE_3__["isEqual"]));
    ...
    set(path, value) {
        const settings = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(this.subject.value);
...
SettingsService = SettingsService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({ providedIn: 'root' }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
], SettingsService);
...
let UserService = class UserService {
    constructor(api, notificationService, settingsService) {
        this.api = api;
        this.notificationService = notificationService;
        this.settingsService = settingsService;
    }
    signUp(data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.user = Object.assign({}, data, { id: Object(short_uuid__WEBPACK_IMPORTED_MODULE_2__["generate"])() });
            yield this.api.register(this.user);
            if (window.localStorage) {
                window.localStorage.setItem('user', JSON.stringify(this.user));
            }
            const enabled = yield this.notificationService.showInitialConfigAlert();
...
module.exports = __webpack_require__(/*! /Users/kschecker/Projects/wirvsvirus/wiegehts/src/main.ts */"./src/main.ts");
